...
const LandingPage = memo(({ onGetStarted, userProfile }) => {
  ...
  const handleGetStartedClick = () => {
    if (typeof onGetStarted === 'function') {
      ...
      console.error('❌ LandingPage: onGetStarted is not a function!', onGetStarted);
    }
  };
          ...
          <div className="nav-container-new">
            ...
            <div className="nav-actions-new">
              {user && userProfile ? (
                ...
                <button onClick={handleGetStartedClick} className="btn-nav-new primary">
                  {user ? 'Contact Admin' : 'Get Started'}
                </button>
              )}
            </div>
          </div>
          ...
          <div className="hero-content-new">
            ...
            {user && userProfile && (
              <div style={{
                ...
                Welcome back, {userProfile.name}! You're successfully logged in.
              </div>
            )}
            ...
            {user && !userProfile && (
              <div style={{
                ...
                <br />
                <small style={{ opacity: 0.9 }}>If this takes too long, try refreshing the page.</small>
              </div>
            )}
            ...
            {user && !userProfile && (
              <div style={{
                ...
                ⚠️ Account Setup Required: Please contact your administrator to complete your account setup.
                <br />
                <button
                  onClick={() => signOut()}
                  style={{
          ...
          <div style={{ position: 'relative', zIndex: 1, maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-6)', justifyContent: 'center', flexWrap: 'wrap' }}>
              {user && userProfile ? (
                ...
                <button onClick={handleGetStartedClick} className="btn-hero-new primary">
                  <Rocket size={24} />
                  Get Started
                </button>
              )}
