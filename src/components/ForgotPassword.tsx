...
const ForgotPassword: React.FC = () => {
  ...
  // Demo users for validation (same as login)
  const demoUsers = [
    {
      id: '1',
      name: 'Ahmed Al-Rashid',
      email: 'ahmed.rashid@adfd.ae',
      role: 'Senior Loan Administrator',
      department: 'Loan Administrator',
      region: 'Middle East',
      permissions: ['create_requests', 'review_requests', 'approve_stage_1']
    },
    {
      id: '2',
      name: 'Sarah Johnson',
      email: 'sarah.johnson@adfd.ae',
      role: 'Core Banking Specialist',
      department: 'Core Banking',
      region: 'Global',
      permissions: ['process_payments', 'manage_accounts', 'generate_reports']
    },
    {
      id: '3',
      name: 'Mohamed Hassan',
      email: 'mohamed.hassan@adfd.ae',
      role: 'Operations Manager',
      department: 'Operations Team',
      region: 'Africa',
      permissions: ['oversee_operations', 'approve_stage_2', 'manage_workflow']
    },
    {
      id: '4',
      name: 'Lisa Chen',
      email: 'lisa.chen@adfd.ae',
      role: 'Archive Coordinator',
      department: 'Archive Team',
      region: 'Asia Pacific',
      permissions: ['archive_documents', 'retrieve_records', 'maintain_database']
    }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        console.log('✅ Password reset email sent successfully (demo)');
      } else {
        setMessage('No account found with this email address and department combination. Please verify your information and try again.');
        setMessageType('error');
      }
        ...
        >
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
              ...
              >
                <label htmlFor="department" className="block text-sm font-semibold text-gray-700 mb-6">
                  Department
                </label>
                <select
                  id="department"
          ...
          <div className="relative z-10 text-center">
            ...
            >
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>Department Verification</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
